...
func Build(workspaceID string, policyEngine *policy.Engine, workspacePath string, cfg *config.Config) (*Components, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("parse tools.web.timeout: %w", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("parse tools.weather.timeout: %w", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("parse tools.finance.timeout: %w", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("parse tools.sports.timeout: %w", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("parse tools.image_query.timeout: %w", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("parse tools.screenshot.timeout: %w", err)
	}
